...
SECRET_KEY = 'django-insecure-&vi-sv_h*fe@^cc&_^m!+#op^k6yk3l!nq9@6v^md9z+1_vpzh'
...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'  # 例: プロジェクト直下に 'staticfiles' ディレクトリを使う
